(function() {
   var managers = ["Juan", "Casal", "Luis", "Mendez", "Toni", "Abel", "Iago", "Pablo", "Boan", "Prol", "Hugo", "Anxo"],
   i = 1,
   length = managers.length,
   fechaActual = new Date(),
   fechaComienzo = new Date(2019, 08, 24, 20, 00, 00, 0),
   results = $('.results'),
   arr = [],
   string = "",
   json = {},
   variableAlmacenamiento = "labuena";
   ...
   function contaAtras() {     
      ...
      fechaActual = new Date();     
      $('#fin').html("Fecha comienzo sorteo: " + fechaComienzo);     
